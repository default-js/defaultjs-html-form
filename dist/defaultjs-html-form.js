...
class Base extends HTMLElement {
	...
	connectedCallback() {
		Promise.resolve(this.init())
			.then(() => {
				this.trigger(_Constants__WEBPACK_IMPORTED_MODULE_0__["TRIGGER_TIMEOUT"], _Constants__WEBPACK_IMPORTED_MODULE_0__["EVENTS"].initialize);
			});
	}
	...
	get condition() {
		if (this.hasAttribute(_Constants__WEBPACK_IMPORTED_MODULE_0__["ATTRIBUTE_CONDITION_INVALID"])) return false;
		return true;
	}
...
class BaseField extends _Base__WEBPACK_IMPORTED_MODULE_4__["default"] {
	...
	async initBaseField() {
			...
			Object(_utils_EventHelper__WEBPACK_IMPORTED_MODULE_2__["toTimeoutHandle"])(
				(event) => {
					if (event.target == this) {
						...
						console.log(_Constants__WEBPACK_IMPORTED_MODULE_1__["EVENTS"].input, { value: this.__value__ });
						this.validate();
					}
				},
				true,
		...
		this.on(
			_Constants__WEBPACK_IMPORTED_MODULE_1__["EVENTS"].changeCondition,
			Object(_utils_EventHelper__WEBPACK_IMPORTED_MODULE_2__["toTimeoutHandle"])((event) => {
				if (event.target == this) {
	...
	async validate() {
		...
		Object(_utils_StateHelper__WEBPACK_IMPORTED_MODULE_3__["updateValidState"])(this, valid);
		this.publishValue();
	}
	...
	async publishValue() {
		...
		console.log("trigger:", _Constants__WEBPACK_IMPORTED_MODULE_1__["EVENTS"].valueChanged, { value , target : this});
		this.trigger(_Constants__WEBPACK_IMPORTED_MODULE_1__["TRIGGER_TIMEOUT"], _Constants__WEBPACK_IMPORTED_MODULE_1__["EVENTS"].valueChanged, value);
	}
...
const TRIGGER_TIMEOUT = 100;
const EVENTHANDLE_TIMEOUT = 200;
...
class Container extends _BaseField__WEBPACK_IMPORTED_MODULE_5__["default"] {
	static get observedAttributes() {
		...
		this.on(_Constants__WEBPACK_IMPORTED_MODULE_2__["EVENTS"].valueChanged,
			(event) => {
				if (event.target != this) {
					...
					console.log(_Constants__WEBPACK_IMPORTED_MODULE_2__["EVENTS"].valueChanged, { name, value, event })
					if (name)
	...
	async initContainer() {
		...
		this.on(_Constants__WEBPACK_IMPORTED_MODULE_2__["EVENTS"].initialize, (event) => {
			if (event.target != this) {
				...
				if (field instanceof _BaseField__WEBPACK_IMPORTED_MODULE_5__["default"]) {
...
const init = (control) => {
	...
	control.form.on(
		Object(_utils_EventHelper__WEBPACK_IMPORTED_MODULE_1__["toEvents"])(_Constants__WEBPACK_IMPORTED_MODULE_0__["EVENTS"].changeCondition, _Constants__WEBPACK_IMPORTED_MODULE_0__["EVENTS"].changeValidation, _Constants__WEBPACK_IMPORTED_MODULE_0__["EVENTS"].changeSite),
		Object(_utils_EventHelper__WEBPACK_IMPORTED_MODULE_1__["toTimeoutHandle"])((event) => {
			control.update();
		}),
	);
};
...
const changeSite = (form) => {
	form.trigger(_Constants__WEBPACK_IMPORTED_MODULE_2__["TRIGGER_TIMEOUT"], _Constants__WEBPACK_IMPORTED_MODULE_2__["EVENTS"].changeSite);
};
...
class Form extends HTMLElement {
		...
		this.on(_Constants__WEBPACK_IMPORTED_MODULE_2__["EVENTS"].valueChanged,
			(event) => {
				if (event.target != this) {
					...
					this.trigger(_Constants__WEBPACK_IMPORTED_MODULE_2__["TRIGGER_TIMEOUT"], _Constants__WEBPACK_IMPORTED_MODULE_2__["EVENTS"].executeValidate)
	...
	set state(state) {
		...
		else if (actual != _Constants__WEBPACK_IMPORTED_MODULE_2__["FORMSTATES"].input && state == _Constants__WEBPACK_IMPORTED_MODULE_2__["FORMSTATES"].input) readonly(this, false);
...
const createRow = (list, value) => {
	...
	const row = new _list_Row__WEBPACK_IMPORTED_MODULE_5__["default"]();
...
const init = (list) => {
	...
	const addButton = (Object(_utils_NodeHelper__WEBPACK_IMPORTED_MODULE_3__["treeFilter"])({
		root: list,
		filter: (element) => {
	...
	list.on(_Constants__WEBPACK_IMPORTED_MODULE_1__["EVENTS"].initialize, (event) => {
		event.preventDefault();
		event.stopPropagation();
	});

	list.on(_Constants__WEBPACK_IMPORTED_MODULE_1__["EVENTS"].listRowAdd, (event) => {
		if (!list.readonly) {
			createRow(list);

			list.trigger(_Constants__WEBPACK_IMPORTED_MODULE_1__["TRIGGER_TIMEOUT"], _Constants__WEBPACK_IMPORTED_MODULE_1__["EVENTS"].changeValue);
		}
		event.preventDefault();
		event.stopPropagation();
	});

	list.on(_Constants__WEBPACK_IMPORTED_MODULE_1__["EVENTS"].listRowDelete, (event) => {
		if (!list.readonly) {
	...
	list.on(
		_Constants__WEBPACK_IMPORTED_MODULE_1__["EVENTS"].changeValue,
		Object(_utils_EventHelper__WEBPACK_IMPORTED_MODULE_2__["toTimeoutHandle"])((event) => {}),
	);
};
...
class List extends _BaseField__WEBPACK_IMPORTED_MODULE_4__["default"] {
	...
	set value(values) {
		...
		if (values instanceof Array) {
			...
			this.trigger(_Constants__WEBPACK_IMPORTED_MODULE_1__["TRIGGER_TIMEOUT"], _Constants__WEBPACK_IMPORTED_MODULE_1__["EVENTS"].changeValue);
		}
	}
}
...
const init = (message) => {
	...
	message.form.on(
		...
		Object(_utils_EventHelper__WEBPACK_IMPORTED_MODULE_3__["toTimeoutHandle"])((event) => {
			message.update();
		}),
	);
	message.update();
...
class Validator {
	constructor(base) {
		...
		base.form.on(
			...
			Object(_utils_EventHelper__WEBPACK_IMPORTED_MODULE_6__["toTimeoutHandle"])((event) => {
				console.log("on", _Constants__WEBPACK_IMPORTED_MODULE_1__["EVENTS"].executeValidate, { event, target: this.target })
				this.validate();
			})
		);
	}
	...
	async validate() {
		...
		const conditionValid = condition ? _default_js_defaultjs_expression_language_src_ExpressionResolver__WEBPACK_IMPORTED_MODULE_0__["default"].resolve(condition, data, false) : true;
		if (target.condition != conditionValid)
			Object(_utils_StateHelper__WEBPACK_IMPORTED_MODULE_3__["updateConditionState"])(target, conditionValid);
...
class ListRow extends _Container__WEBPACK_IMPORTED_MODULE_2__["default"] {
	...
	static init(row) {
		_Container__WEBPACK_IMPORTED_MODULE_2__["default"].init(row);
		init(row);
	}
...
const updateValidState = (target, valid,initial = false) => {
	...
	if (oldState != valid || initial) target.trigger(_Constants__WEBPACK_IMPORTED_MODULE_0__["TRIGGER_TIMEOUT"], _Constants__WEBPACK_IMPORTED_MODULE_0__["EVENTS"].changeValidation);
};
...
const updateConditionState = (target, valid, initial = false) => {
	...
	if (oldState != valid || initial) target.trigger(_Constants__WEBPACK_IMPORTED_MODULE_0__["TRIGGER_TIMEOUT"], _Constants__WEBPACK_IMPORTED_MODULE_0__["EVENTS"].changeCondition);
};
...
const updateActiveState = (target, active, initial = false) => {
	...
	if (oldState != active || initial) target.trigger(_Constants__WEBPACK_IMPORTED_MODULE_0__["TRIGGER_TIMEOUT"], _Constants__WEBPACK_IMPORTED_MODULE_0__["EVENTS"].changeActive);
};
...
/******/ });
//# sourceMappingURL=data:application/json;charset=utf-8;base64,