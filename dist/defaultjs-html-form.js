...
class BaseField extends _Base__WEBPACK_IMPORTED_MODULE_4__["default"] {
	...
	async initBaseField() {
		...
		this.form.on(_Constants__WEBPACK_IMPORTED_MODULE_1__["EVENTS"].allPublishValue, ()=> {
			this.publishValue();
		});
